...
//   const restartButtonFromWin = document.getElementById("restart-button-from-win");
//   const restartButtonFromLose = document.getElementById("restart-button-from-lose");
//   const restartButtonFromHighScore = document.getElementById("high-score-play-again");

//   if (restartButton) restartButton.addEventListener("click", restartGame);
//   if (restartButtonFromWin) restartButtonFromWin.addEventListener("click", restartGame);
//   if (restartButtonFromLose) restartButtonFromLose.addEventListener("click", restartGame);
//   if (restartButtonFromHighScore) restartButtonFromHighScore.addEventListener("click", restartGame);
// });
...
//   const button = document.getElementById('you-won-to-enter-name-modal');
//   if (button) {
//     button.addEventListener('click', function() {
//       $('#well-done-modal').modal('hide');
...
// document.addEventListener('DOMContentLoaded', function() {
//   // Ensure that 'submitNameBtn' is actually in the DOM
//   const submitButton = document.getElementById('submitNameBtn');
//   console.log(submitButton); // This will help verify if the button is found
...
//       // Get current high scores from local storage, or initialize as an empty object if none exist
//       let currentHighScore = JSON.parse(localStorage.getItem('highScores')) ?? {};
      
//       // Update the high score list with the new score
//       currentHighScore[playerName] = $('#turns-left-count').text();
      
//       // Save the updated high score list back to local storage
...
//     });
//   } else {
//     console.error("Element 'submitNameBtn' not found in the DOM.");
//   }
// });
